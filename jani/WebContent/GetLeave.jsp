...
<form action="GetLeaveServlet" method="post" style="border:1px solid #ccc">
  <div class="container">
    <h1><center><font size="7" color="blue">Leave Form</font></h1></center>
